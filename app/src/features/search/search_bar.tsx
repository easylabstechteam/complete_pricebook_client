...
function SearchBar() {
  ...
  return (
    ...
    <div className="w-full max-w-2xl mx-auto p-2 sm:p-4">
      <div
        className="relative flex items-center bg-white border border-gray-300 rounded-l shadow-lg transition-all duration-200 
      ...
      >
        ...
        <input
          ...
          // Disables text input while an API call is in progress.
